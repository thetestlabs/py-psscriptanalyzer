...
def test_main_with_mixed_files(monkeypatch):
    ...
    monkeypatch.setattr(cli, "run_script_analyzer", 
                       lambda cmd, files, format_files=False, severity="Warning", 
                       security_only=False, style_only=False, performance_only=False,
                       best_practices_only=False, dsc_only=False, compatibility_only=False,
                       include_rules=None, exclude_rules=None, 
                       output_format="text", output_file=None: 0)
...
def test_main_with_format_option(monkeypatch):
    ...
    monkeypatch.setattr(cli, "check_psscriptanalyzer_installed", lambda cmd: True)
    monkeypatch.setattr(cli, "run_script_analyzer", 
                       lambda cmd, files, format_files=True, severity="Warning", 
                       security_only=False, style_only=False, performance_only=False,
                       best_practices_only=False, dsc_only=False, compatibility_only=False,
                       include_rules=None, exclude_rules=None,
                       output_format="text", output_file=None: 0)
...
def test_main_script_analyzer_with_issues(monkeypatch):
    ...
    monkeypatch.setattr(cli, "run_script_analyzer", 
                      ...
                      best_practices_only=False, dsc_only=False, compatibility_only=False,
                      include_rules=None, exclude_rules=None,
                      output_format="text", output_file=None: 1)
...
def test_main_with_real_files(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(cli, "run_script_analyzer", 
                          ...
                          best_practices_only=False, dsc_only=False, compatibility_only=False,
                          include_rules=None, exclude_rules=None,
                          output_format="text", output_file=None: 0)    # Run with recursive option from the tmp_path
...
def test_find_powershell_files_default_dir():
    ...
    with patch("py_psscriptanalyzer.cli.Path.cwd") as mock_cwd, \
         patch("py_psscriptanalyzer.cli.Path.glob") as mock_glob:
